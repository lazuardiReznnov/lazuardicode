...
<div class="card col-md-6">
    ...
    <div class="card-body">
        <form action="/dashboard/unit/letter/{{ $data->id }}" method="post">
            @csrf @method('put')
            ...
            <div class="form-floating mb-3">
                ...
                >
                    ...
                    @if(old('category_letters_id',$data->category_letters_id)==$category_letters->id)
            ...
            <div class="form-floating mb-3">
                <textarea
                    ...
                    id="floatingTextarea"
                    name="owner_add"
                    >{{ old("owner_add", $data->owner_add) }}</textarea
                >
